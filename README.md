...
- *Full Insight* — a snapshot of overall performance by category, region, and product
- *Sales Trend* — a month-by-month breakdown across 2022, 2023, and 2024
...
- Has the business been growing year on year, or are the numbers masking a plateau?
- Which individual products are the real earners, and which ones are just taking up shelf space?

The goal of this dashboard was to answer all of those in one place, without needing to dig through spreadsheets every time someone asked a question.
...
This dashboard does a solid job of bringing everything into one place and making the numbers accessible. The business is generating $11M in sales and $1.84M in profit, which isn't a bad position to be in — but the data also shows a business that's plateauing rather than growing.

The even spread across regions and products means there's no obvious weak link dragging things down, but there's also no obvious engine pulling things forward. The opportunity here isn't to fix something broken — it's to make a deliberate choice about where to focus, because right now it looks like effort and resources are spread too thin to accelerate growth in any one direction.

The next step would be layering in customer-level data and cost breakdowns to understand where the real margin opportunities sit — but as a starting point for that conversation, this dashboard gives the business exactly what it needs.
...
- *DAX* — calculated measures for profit margins and totals
- *Data Source* — internal sales transaction data (2022–2024)
